...
set(LIBS common;blocks;cryptonote_basic;cryptonote_core;epose;multisig;
        ...
        checkpoints;randomx;hardforks;net;miniupnpc)
...
foreach (l ${LIBS})
	...
	if("${l}" STREQUAL "miniupnpc" AND "${Xmr_${L}_LIBRARY}" STREQUAL "Xmr_${L}_LIBRARY-NOTFOUND")
		find_library(Xmr_${L}_LIBRARY
			NAMES ${l}
		)
	endif()
