...
MempoolStatus::read_mempool()
{
    ...
    for (size_t i = 0; i < mempool_tx_info.size(); ++i)
    {
        ...
        // public keys and QWC amount of outputs
        vector<output_tuple_with_tag> output_pub_keys;

        // sum QWC in inputs and outputs in the given tx
...
bf::path MempoolStatus::blockchain_path {"/home/qwertycoin/.qwertycoin/lmdb"};
string MempoolStatus::daemon_url {"http://127.0.0.1:8197"};
